          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 relative">
              ...
              <span className="absolute -bottom-6 right-0 md:right-4 text-base text-primary/80 font-mono tracking-wider">&lt;/developer&gt;</span>
                 ...
                 <motion.h2 
                className="text-2xl md:text-3xl font-semibold mb-6 mt-8 flex flex-wrap items-center gap-3 sm:gap-4"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                ...
                <span className="typing-effect font-bold text-purple-500 text-xl md:text-3xl">
